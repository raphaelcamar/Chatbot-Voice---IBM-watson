...
<html lang="pt-br">
   ...
   <body>
      ...
      <div class="card-deck">
         <div class="card">
            ...
            <div class="card-body">
               ...
               <p class="card-text">EAD focado em ajudar oferecer apoio à matéria de algoritmo</p>
         ...
         <div class="card">
            ...
            <div class="card-body">
               ...
               <p class="card-text">EAD focado em passar conhecimentos de negócio</p>
               <p class="botao"><a href="#">Conteudo</a></p>
            </div>
         </div>
         <div class="card">
            ...
            <div class="card-body">
               ...
               <p class="card-text">EAD focado em fortalecer alguns conceitos matemáticos</p>
               <p class="botao"><a href="#">Conteudo</a></p>
            </div>
         </div>
      </div>
      <section class="chatbot">
         <div class="chat"></div>
         <input type="text" name="pergunta" id="pergunta" class="pergunta" placeholder="Tire sua dúvidas aqui!">
         <div class="control">
